...
### [1.6.5]
- `pl_pl` localisation updated by [@goodideagiver](https://github.com/goodideagiver) ([#16])
...
### [1.6.3]
- Added `sv_se` translation by [@Luracasmus](https://github.com/Luracasmus) ([#13])

### [1.6.2]
- Added `ru_ru` translation by [@Felix14-v2](https://github.com/Felix14-v2) ([#12])
...
- Fixed invalid data in compiled `fabric.mod.json` ([#10])

### [1.5.0]
- Added an option to change the bar background color ([#8]), suggested by [@Chrisblox](https://github.com/Chrisblox))
- Fixed the reset buttons sometimes not working
- `zh_cn` localisation updated by [@Hambaka](https://github.com/Hambaka) ([#9])

### [1.4.4]
- Fixed some potential incompatibilities with other mods
- `zh_cn` localisation updated by [@Hambaka](https://github.com/Hambaka) ([#7])
...
### [1.4.1]
- Fixed the background color getting added to the logo color ([#5])
- Added `es_xx` localisations by [@Haseck](https://github.com/Haseck) ([#6])

### [1.4.0]
- Added an option to change the Mojang logo color ([#3]), suggested by [@Minenash](https://github.com/Minenash))
- Made the config file indented instead of on a single line

### [1.3.3]
- Added `pl_pl` localisation by [@DarkKnightComes](https://github.com/DarkKnightComes) ([#4])

### [1.3.2]
- Added `zh_cn` localisation by [@w5860363](https://github.com/w5860363) ([#2])

### [1.3.1]
- Fixed the bar borders being the wrong colors with OptiFine 1.16.1 ([#1])
...
[#1]: https://github.com/A5b84/dark-loading-screen/issues/1
[#2]: https://github.com/A5b84/dark-loading-screen/pull/2
[#3]: https://github.com/A5b84/dark-loading-screen/issues/3
[#4]: https://github.com/A5b84/dark-loading-screen/pull/4
[#5]: https://github.com/A5b84/dark-loading-screen/issues/5
[#6]: https://github.com/A5b84/dark-loading-screen/pull/6
[#7]: https://github.com/A5b84/dark-loading-screen/pull/7
[#8]: https://github.com/A5b84/dark-loading-screen/issues/8
[#9]: https://github.com/A5b84/dark-loading-screen/pull/9
[#10]: https://github.com/A5b84/dark-loading-screen/pull/10
[#12]: https://github.com/A5b84/dark-loading-screen/issues/12
[#13]: https://github.com/A5b84/dark-loading-screen/pull/13
[#16]: https://github.com/A5b84/dark-loading-screen/pull/16
